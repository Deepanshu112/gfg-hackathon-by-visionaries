...
const NavBar = () => {
  ...
  return (
    ...
    className={`${isHome ? navBg : "bg-white dark:bg-black backdrop-blure-2xl"} ${isFixed? 'static' : 'fixed'} top-0 transition-colors duration-500 ease-in-out w-full z-10`}>
        <div className='lg:w-[95%] mx-auto sm:px-6 lg:px-6'>            
            <div className='px-4 py-4 flex items-center justify-between'>
                {/* logo */}
                <div onClick={() => navigate('/')} className='flex-shirnk-0 cursor-pointer pl-7 md:p-0 flex items-center'>
                    <div>
                        <h1 className='text-2xl inline-flex gap-3 items-center font-bold'>
                            LigoFit <img src="/yoga-logo.png" className='w-8 h-8' alt="" />
                        </h1>
